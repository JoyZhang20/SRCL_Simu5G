...
//        {
//            EV << "huang maxCpu==" << maxCPU << endl;
//            EV << "huang second.resources.cpu==" << ueApp->second.resources.cpu << endl;
//            currentSpeed = ueApp->second.resources.cpu *(maxCPU/allocatedCPU);
//            currentSpeed2 = maxCPU * 0.2;
//            EV << "huang currentSpeed2==" << currentSpeed2 << endl;
//            time2 = numOfInstructions/(pow(10,6)*currentSpeed2);
//            EV << "huang time==" << time2 << endl;
//
//            time = numOfInstructions/(pow(10,6)*currentSpeed);
//
//        }
...
//        {
//            currentSpeed = ueApp->second.resources.cpu;
//            EV << "elsehuang currentSpeed==" << currentSpeed << endl;
//            time = numOfInstructions/(pow(10,6)*currentSpeed);
//        }
